...
// 16. Attribute 1: INTELLECT (Ancient tome & scroll)
...
// 17. Attribute 2: STRENGTH (Heavy broadsword)
...
// 18. Attribute 3: AGILITY (Swift wing feather)
...
// 19. Attribute 4: VITALITY (Shield with pulse heart)
export const IconVitality: React.FC<IconProps> = ({ size = 24, filled = false, className = '', ...props }) => (
  ...
  >
    <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
    <path d="M8 12h2l1.5-3 2 6 1-3h1.5" strokeWidth="1.8" />
  </svg>
);
export const IconAttributeVitality = IconVitality;

// 20. Attribute 5: SPIRIT (Four-point celestial star)
