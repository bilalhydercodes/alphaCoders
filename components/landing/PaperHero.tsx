  ...
  ({ onOpenAuth, textRef }, ref) => {
    return (
      <div
        ...
        className="absolute top-0 inset-x-0 z-30 h-[50vh] bg-draft-paper border-b border-[#2A2825] shadow-[0_12px_36px_rgba(0,0,0,0.3)] flex flex-col justify-between pt-16 sm:pt-20 pb-3 px-4 sm:px-10 select-none overflow-hidden will-change-transform"
      >
