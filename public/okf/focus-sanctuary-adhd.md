...
extraction_keywords:
  - adhd habit tracker
  - delayed gratification solution
  - pomodoro focus sanctuary
  - tactile dopamine loops
  - procedural audio synthesizer
---

# Focus Sanctuary & ADHD Neurodivergent Design Loops

## 1. The Delayed Gratification Problem

The fundamental obstacle to sustained habit adherence—particularly for individuals with Attention-Deficit/Hyperactivity Disorder (ADHD)—is the **neurobiological discount rate of delayed rewards**.

In the human prefrontal cortex:
- Evolutionary survival prioritized immediate stimuli over distant hypothetical outcomes.
- Studying for an exam today only provides a reward in 3 months.
- Going to the gym today only provides visible muscular hypertrophy in 6 months.
...
### 2. Ballistic Particle Physics (XP Arcs)
...
### 4. Floating Combat Numbers
Floating text indicators (`+60 XP`, `+35 GP`, `-156 DMG`) rise and fade dynamically over the interface, borrowing the visceral feedback loop of action role-playing games (ARPGs).

## 3. Deep Focus Sanctuary (Pomodoro Engine)

By pressing `F` or selecting Focus Mode, users enter the **Deep Focus Sanctuary**:
- **Default Work Sprint**: 25-minute concentrated session.
- **Companion Integration**: Lumi sits alongside the user with her small purple adventurer's laptop, entering the `Focused` behavioral state.
- **Ambient Soundscapes**: Procedurally synthesized binaural background pink noise to drown out distracting auditory environments.
- **Sprint Completion Yield**: Automatically credits Intellect XP and Bounty Gold upon timer expiration, preventing the feeling that focus time went unrecorded.
